                ...
                while (isLoggedIn && isRunning) {
                    ...
                    switch (option) {
                        ...
                        case "3":
                            ...
                            System.out.print("\n-------------------------\n\n");
                            respostaServidor = ((ConsultationUtility)client).updateConsulta(consultaIdInt, novaDataAtualizada , userId);
                            System.out.println(respostaServidor);
                            System.out.print("\n-------------------------\n");
                            break;
                        ...
                        case "4":
                            ...
                            System.out.print("\n-------------------------\n\n");
                            respostaServidor = ((ConsultationUtility)client).cancelarConsulta(consultaRemoverIdInt, userId);
                            System.out.println(respostaServidor);
                            System.out.print("\n-------------------------\n");
                            break;
